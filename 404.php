...
<html style="height:100%">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="https://i.imgur.com/TKrxw5m.jpg">
        <link rel="icon" href="https://i.imgur.com/TKrxw5m.jpg">
    </head>
    <body>
        <div class="about">
...
<!-- end about -->
    ...
    <section class="wrapper">
        ...
        <div class="container">
            ...
            <div class="text">
                <article>
                    <p>Looks like the page you visited doesn't exist. <br>Please return to the main page</p>
